...
frontend/
  LinguaBotIndia.jsx  ← React component (drop into your Vite/CRA app)
```
...
The SQLite database (`linguabot.db`) is created automatically on first run,
...
Make sure the API URL in `LinguaBotIndia.jsx` matches your backend:
```js
